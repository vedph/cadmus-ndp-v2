...
/// <summary>
/// NdpDrawings part seeders provider.
/// </summary>
/// <seealso cref="IPartSeederFactoryProvider" />
public sealed class NdpDrawingsPartSeederFactoryProvider :
    IPartSeederFactoryProvider
{
    private static IHost GetHost(string config)
    {
        ...
        [
            ...
            // Cadmus.Seed.NdpDrawings.Parts
            typeof(DrawingTechPartSeeder).GetTypeInfo().Assembly,
        ];
